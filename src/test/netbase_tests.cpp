...
{
    BOOST_CHECK(TestSplitHost("www.identifi.org", "www.identifi.org", -1));
    BOOST_CHECK(TestSplitHost("[www.identifi.org]", "www.identifi.org", -1));
    BOOST_CHECK(TestSplitHost("www.identifi.org:80", "www.identifi.org", 80));
    BOOST_CHECK(TestSplitHost("[www.identifi.org]:80", "www.identifi.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4944", "127.0.0.1", 4944));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4944", "127.0.0.1", 4944));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4944", "::ffff:127.0.0.1", 4944));
    BOOST_CHECK(TestSplitHost("[::]:4944", "::", 4944));
    BOOST_CHECK(TestSplitHost("::4944", "::4944", -1));
    BOOST_CHECK(TestSplitHost(":4944", "", 4944));
    BOOST_CHECK(TestSplitHost("[]:4944", "", 4944));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4944", "127.0.0.1:4944"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4944", "[::]:4944"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
