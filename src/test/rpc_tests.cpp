...
BOOST_AUTO_TEST_CASE(save_and_read_relations)
{
    ...
    //BOOST_CHECK_NO_THROW(r=CallRPC("saverelationfromdata '[6865346651654554112,[[\"mbox\",\"mailto:alice@example.com\"],[\"profile\",\"http://www.example.com/alice\"]],[[\"mbox\",\"mailto:bob@example.com\"],[\"profile\",\"http://www.example.com/bob\"]],\"#positive\"]'"));
