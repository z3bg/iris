...
{
    return GetBoolArg("-testnet", false) ? 14945 : 4945;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "Stop Identifi server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Identifi server stopping";
}
...
{ //  name                          actor (function)            okSafeMode
  //  ------------------------      -------------------------   ----------
    ...
    { "getpathlength",               &getpathlength,              true },
    { "gettrustdistance",               &gettrustdistance,              true },
    { "getidentifiercount",         &getidentifiercount,        true },
    { "getmsgbyhash",               &getmsgbyhash,              true },
    { "getmsgsbyauthor",            &getmsgsbyauthor,           true },
    { "getmsgsbyrecipient",         &getmsgsbyrecipient,        true },
    { "getmsgsafter",               &getmsgsafter,              true },
    { "getlatestmsgs",              &getlatestmsgs,             true },
    { "saverating",                 &saverating,                true },
    { "rate",                       &rate,                      true },
    { "search",                     &search,                    true },
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: identifi-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
//
// JSON-RPC protocol.  Identifi speaks version 1.0 for maximum compatibility,
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use identifid";
