    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new IdentifiUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->identifiAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Identifi."), QMessageBox::Ok);
