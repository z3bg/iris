...
#ifndef H_IDENTIFI_SCRIPT
#define H_IDENTIFI_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CIdentifiAddress
 */
...
public:
    ...
    // Pre-version-0.6, Identifi always counted CHECKMULTISIGs
