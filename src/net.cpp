...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Identifi " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    // {"test-info.identifi.org", "test-seed.identifi.org"}, // TODO:
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Identifi is probably already running."), addrBind.ToString().c_str());
        else
