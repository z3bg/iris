...
unlocked to sign the Identifi-Qt.app bundle.
...
allowing somebody to distribute a Identifi-Qt.app or identifi-qt-setup.exe with a valid
...
that the identifi-qt.exe file inside the installer had not been tampered with.
