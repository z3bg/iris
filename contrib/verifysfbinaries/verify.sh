...
WORKINGDIR="/tmp/identifi"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/identifi/Identifi/identifi-0.8.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/identifi/Identifi/"
VERSIONPREFIX="identifi-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'identifi-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[identifi-]<version>-[rc[0-9]] (example: identifi-0.7.1-rc1)"
   echo "wget output:"
